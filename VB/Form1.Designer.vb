Namespace S132472
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.nwindDataSet = New S132472.nwindDataSet()
			...
			Me.productReportsTableAdapter = New S132472.nwindDataSetTableAdapters.ProductReportsTableAdapter()
			...
			Me.pivotGridControl1.Size = New System.Drawing.Size(634, 411)
			Me.pivotGridControl1.TabIndex = 0
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.pivotGridControl1.FieldFilterChanged += new DevExpress.XtraPivotGrid.PivotFieldEventHandler(this.pivotGridControl1_FieldFilterChanged);
			' 
			...
			Me.Name = "Form1"
			Me.Text = "How to Display Field Filter In Prefilter Dialog"
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.Load += new System.EventHandler(this.Form1_Load);
		...
		Private productReportsTableAdapter As S132472.nwindDataSetTableAdapters.ProductReportsTableAdapter
